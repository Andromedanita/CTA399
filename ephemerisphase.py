...
if __name__ == '__main__':
    ...
    mjd = Time('2013-05-16 23:45:00', scale='utc').mjd
    ...
    #appending doppler delay to the delay and changing the units to day instead of seconds
