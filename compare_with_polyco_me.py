...
polyco_file = os.path.dirname(pulsar.__file__) + \
    '/cita/h/home-2/bahmanya/python/pulsar/pulsar/tests/data/polyco_new_1957_17may13.dat'
...
if __name__ == '__main__':
    ...
    eph_phasepol = np.polyfit(mjd_range,Phase,3)
    eph_freq_and_derivs = [eph_phasepol.deriv(i).coef[0] for i in range(1,len(phasepol))]
